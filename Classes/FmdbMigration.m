...
//  Copyright 2008  Dr Nic. All rights reserved.
//
...
- (void)up 
{
	DLog([NSString stringWithFormat:@"%s: -up method not implemented", NSStringFromClass([self class])]);
}

- (void)down 
{
	DLog([NSString stringWithFormat:@"%s: -down method not implemented", NSStringFromClass([self class])]);
}
