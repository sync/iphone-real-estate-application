...
- (void)drawRect:(CGRect)rect {
	...
	if (self.min) {
		[textColor set];
		[self.min drawInRect:CGRectMake(self.bounds.origin.x + 10 + 5.0, self.bounds.origin.y + 13.0 + 13.0 + 12.0, 100.0, 16.0) withFont:boldFont lineBreakMode:UILineBreakModeTailTruncation alignment:UITextAlignmentLeft];
		
	}
	
	if (self.max) {
		[textColor set];
		[self.max drawInRect:CGRectMake(self.bounds.origin.x + 10 + 5.0, self.bounds.origin.y + 13.0 + 13.0 + 10.0 + 17.0, 100.0, 16.0) withFont:boldFont lineBreakMode:UILineBreakModeTailTruncation alignment:UITextAlignmentLeft];
